...
## Using flatcc in CMake projects
...
Note: normally COMMON should also be specified along with BUILDER unless common files
are generated by another build step. For simple configurations ALL is likely the best choice.
